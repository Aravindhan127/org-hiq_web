...
const DialogCity = (props) => {
    const { mode, open, toggle, dataToEdit, onSuccess, id, cid } = props;
    ...
    const onSubmit = (data) => {
        let payload = {
            ...
            stateId: id,
            countryId: cid,
            ...(mode === "edit" && { cityRecordId: dataToEdit?.id })
        }
        ...
        if (mode === "edit") {
            apiInstance = axiosInstance
                .post(ApiEndPoints.CITY.edit, payload)
        } else {
            apiInstance = axiosInstance
                .post(ApiEndPoints.CITY.create, payload)
        }
        apiInstance
