...
const DialogJobs = (props) => {
    ...
    useEffect(() => {
        if (open) {
            setLoading(false);
            setDialogTitle(mode === "add" ? "Add Jobs" : "Edit Jobs");
            reset({
    ...
    const onSubmit = (data) => {
        ...
        let payload = {
            name: data.name,
            ...(mode === "edit" && { jobId: dataToEdit.id })
        }
        setLoading(true);
        let apiInstance = null;
        if (mode === "edit") {
            apiInstance = axiosInstance
                .post(ApiEndPoints.JOBS.edit, payload, {
                })
        } else {
            apiInstance = axiosInstance
                .post(ApiEndPoints.JOBS.create, payload, {
                })
        }
        apiInstance
