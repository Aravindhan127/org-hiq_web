...
const DialogOrg = (props) => {
    ...
    useEffect(() => {
        if (open) {
            setLoading(false);
            setDialogTitle(mode === "add" ? "Add Organization" : "Edit Organization");
            fetchEditData()
        }
        getCountryList()
            ...
            <DialogContent sx={{ pb: 8, px: { sx: 8, sm: 15 }, pt: { xs: 8, sm: 12.5 } }}>
                <form id="hub-address-form" onSubmit={handleSubmit(onSubmit)}>
                    <Grid container spacing={4}>
                        ...
                        <Grid item xs={6}>
                            <FormControl fullWidth>
                                <FormLabel required htmlFor='email' error={Boolean(errors.email)}>Email</FormLabel>
                                <Controller
                                    name="email"
                                    control={control}
                                    render={({ field: { value, onChange } }) =>
                        ...
                        <Grid item xs={6}>
                            <FormControl fullWidth>
                                <FormLabel required htmlFor='url' error={Boolean(errors.email)}>Website Url</FormLabel>
                                <Controller
                                    name="url"
                                    control={control}
                                    render={({ field: { value, onChange } }) =>
                        ...
                        {/* <Grid item xs={6}>
                            <FormControl fullWidth>
                                <FormLabel required htmlFor='industry' error={Boolean(errors.industry)}>
                                    Industry
                                </FormLabel>
                                <Controller
                                    name='industry'
                        ...
                        <Grid item xs={6}>
                            <FormControl fullWidth>
                                <FormLabel required htmlFor='zipcode' error={Boolean(errors.zipcode)}>Zip Code</FormLabel>
                                <Controller
                                    name="zipcode"
                                    control={control}
