...
import TableCareerCategories from 'src/views/tables/TableCareerCategories'
import DialogCareerCategories from 'src/views/dialog/DialogCareerCategories'
...
const CareerCategoriesPage = () => {
    ...
    const fetchData = ({ currentPage, pageSize = DefaultPaginationSettings.ROWS_PER_PAGE, search }) => {
        ...
        axiosInstance
            .get(ApiEndPoints.CAREER_CATEGORY.list, { params })
            .then(response => {
    ...
    const onConfirmDelete = useCallback(
        e => {
            ...
            axiosInstance
                .delete(ApiEndPoints.CAREER_CATEGORY.delete(careerToDelete._id))
    ...
    return (
        <>
                ...
                <PageHeader
                    title={
                        <Typography variant='h5'>
                            <Translations text='Career Categories' />
                        </Typography>
                    }
                    action={
            ...
            <DialogConfirmation
                ...
                title='Delete Career Category'
                subtitle='Are you sure you want to delete this Career Category?'
